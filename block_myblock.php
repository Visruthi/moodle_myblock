...
class block_myblock extends block_base {
    ...
    function get_content() {
        ...
        $this->content->text   = '<form  method = "POST" action=""><h3>Add a new Announcement</h3><input name="title" placeholder="Title"><input name="desc" placeholder="Description"><br><h5>Start date</h5> <input type="date" name="start_date"><br><h5>End date</h5><input type="date" name="end_date"> <input type="submit" value="Add"></form>';
        $this->content->footer = '';

        $title =  html_writer::tag('p',get_string('pagetitle','block_myblock'));
